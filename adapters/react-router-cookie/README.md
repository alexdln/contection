...
A cookie-based persistence adapter for [contection](https://github.com/alexdln/contection) that automatically saves and restores state to browser cookies. Designed for React Router [v7] applications with full server-side rendering support.
